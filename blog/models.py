...
class Post(models.Model):
    ...
    likes = models.ManyToManyField(User, related_name="liked_posts", verbose_name="Кто лайкнул", blank=True, db_index=True)
...
class Comment(models.Model):
    ...
    author = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name="Автор", db_index=True)
